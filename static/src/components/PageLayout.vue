<template>
  <div class="relative min-h-screen lg:flex" data-testid="page-layout">
    <!-- Menubar -->
    <NavBar class="hidden portrait:sd:hidden portrait:md:flex landscape:flex z-[9999]"/>
    <MobileNavBar class="flex portrait:sd:flex portrait:md:hidden landscape:hidden z-[9999]"/>
